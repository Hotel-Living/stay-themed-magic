...
const orderedCategoryIds = [
  "video", "beneficios", "modelos", "ingresos", "huespedes", "mayores", 
  "afinidades", "operativa", "integracion", "marketing", "pagos", 
  "pasos", "alquiler"
];
      ...
      <main className="flex-1 pt-16">
        <div className="container max-w-4xl mx-auto px-4 py-3">
          <div className="text-center mb-4">
            ...
            `}>
              FAQ Socios Hoteleros
            </h1>
            <p className={`${isMobile ? "text-xl" : "text-base"} font-medium text-[#e3d6e9] mb-6`}>
              Encuentra respuestas a preguntas comunes sobre unirse a Hotel-Living como socio hotelero
            </p>
            
            <FaqSearch 
              searchQuery={searchQuery}
              setSearchQuery={setSearchQuery}
              placeholder="Buscar FAQ socios..."
            />
          </div>
