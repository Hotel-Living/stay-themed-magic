          ...
          <div className={`w-full max-w-4xl ${isMobile ? "mb-6" : "mb-8"}`}>
            <div className={`grid ${isMobile ? "grid-cols-2 gap-x-8 gap-y-6" : "grid-cols-4 gap-8"} text-center text-white text-sm font-bold`}>
              ...
              <div className="space-y-2">
                <div className="text-purple-800 font-bold text-xl mb-2 bg-white px-3 py-1 rounded inline-block">{t('footer.sections.aboutUs')}</div>
              ...
              {/* Column 4: Legal */}
              <div className="space-y-2">
                <div className="text-purple-800 font-bold text-xl mb-2 bg-white px-3 py-1 rounded inline-block">{t('footer.sections.legal')}</div>
                <div className="space-y-1">
