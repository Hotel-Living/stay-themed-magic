  ...
  return <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        field
              ...
              <FormControl>
                <Input placeholder="Your email address" {...field} className="bg-[#3A0952]/30 border-[#8017B0] text-white placeholder:text-white/60" />
              </FormControl>
              <FormMessage />
            </FormItem>} />
        ...
        field
              ...
              <FormControl>
                <Textarea placeholder="Tell us about yourself and how you'd like to contribute" {...field} className="bg-[#3A0952]/30 border-[#8017B0] text-white placeholder:text-white/60 min-h-[120px]" />
              </FormControl>
              <FormMessage />
            </FormItem>} />
        ...
        <Button type="submit" className="w-full bg-[#8017B0] hover:bg-[#9028C1] text-white transition-all duration-300" disabled={isSubmitting}>
