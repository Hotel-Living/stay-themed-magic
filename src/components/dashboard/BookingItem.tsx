...
export const BookingItem = ({ name, dates, property, status }: BookingItemProps) => {
  return (
    <div className="flex items-start p-3 rounded-lg bg-fuchsia-950/30 border border-fuchsia-800/20">
