...
import { validateAccommodationTerms, formatMonths } from "./utils/validation";
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4 bg-fuchsia-950/30">
        <h3 className="font-medium mb-3">3.1— STAY DURATION</h3>
        <p className="text-sm text-gray-300 mb-4">Select all stay durations you offer:</p>
      ...
      <Card className="p-4 bg-fuchsia-950/30">
        <h3 className="font-medium mb-3">3.2— SINGLE CHECK-IN / CHECK-OUT DAY</h3>
        <p className="text-sm text-gray-300 mb-4">Select the day guests check in and check out:</p>
        <div className="flex flex-wrap gap-3">
