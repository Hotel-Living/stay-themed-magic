...
export const AccommodationTermsStep: React.FC<AccommodationTermsStepProps> = ({
  ...
  return <div className="space-y-6">
      ...
      <Card className="p-4 bg-fuchsia-950/30">
        ...
        {showErrors && stayDurations.length === 0 && <p className="text-red-400 text-sm mt-2">Please select at least one stay duration</p>}
      </Card>
      ...
      <Card className="p-4 bg-fuchsia-950/30">
        ...
        {showErrors && mealPlans.length === 0 && <p className="text-red-400 text-sm mt-2">Please select at least one meal plan</p>}
      </Card>
