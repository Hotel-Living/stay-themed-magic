...
export default function BasicInfoStep() {
  return <div className="space-y-5">
      <div>
        ...
        <input type="text" placeholder="Enter hotel name" required className="w-full p-2.5 rounded-lg border border-fuchsia-800/30 focus:border-fuchsia-500/50 focus:ring-1 focus:ring-fuchsia-500/30 bg-[#7d0099]" />
      </div>
