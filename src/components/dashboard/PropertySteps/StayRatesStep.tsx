        ...
        <Collapsible className="w-full" defaultOpen>
          ...
          <CollapsibleContent>
            ...
            <div className="grid grid-cols-1 gap-4 mb-6">
              <div>
                {/* Updated currency selector layout */}
                <div className="flex items-center mb-2">
                  <label className="block text-sm uppercase mr-3 whitespace-nowrap">CURRENCY:</label>
                  <div className="flex flex-nowrap overflow-x-auto gap-1">
                    {currencies.map((curr) => (
                      <button
                        key={curr.code}
                        className={`py-0.5 px-1.5 text-xs border rounded-lg transition-colors ${
                          currency === curr.code
