  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-8">
        ...
        {/* Add Room Type Button - Collapsible form */}
        ...
        {/* Available Room Types - Collapsible list */}
        {roomTypes.length > 0 && (
          <Collapsible 
            className="w-full border rounded-xl overflow-hidden" 
            open={isAvailableRoomsOpen} 
            onOpenChange={setIsAvailableRoomsOpen}
          >
                ...
                {roomTypes.map(room => (
                  <div key={room.id} className="p-4 border rounded-md flex justify-between items-center">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm" 
                      onClick={() => handleRemoveRoomType(room.id)} 
