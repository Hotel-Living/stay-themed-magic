    ...
    <Collapsible defaultOpen={false} className="w-full">
      <div className="bg-[#6c0686]">
        <CollapsibleTrigger className="flex items-center justify-between w-full p-2">
          <label className="block text-xl font-bold text-foreground/90 uppercase">2.1- AFINIDADES</label>
      ...
      <CollapsibleContent>
        <p className="text-sm text-foreground/90 mb-4">
          Haga que su hotel se destaque de la competencia potenciándolo con afinidades grupales para atraer a sus mejores y perfectos huéspedes
        </p>
