            ...
            <TabsContent value="model-rates-calculator">
              ...
              <Tabs value={modelTab} onValueChange={setModelTab} className="w-full">
                <TabsList className="flex w-full mb-6 gap-1 bg-gradient-to-br from-cyan-400 to-purple-600 rounded-xl shadow-lg">
                  <TabsTrigger
                    value="read-this"
                    className="flex-1 text-xs md:text-base font-bold uppercase tracking-tight rounded-none data-[state=active]:bg-[#12002b] data-[state=active]:text-fuchsia-100 text-white bg-transparent px-1 md:px-4 py-4 transition-all"
                  >
                    PLEASE READ THIS
                  </TabsTrigger>
                  <TabsTrigger
