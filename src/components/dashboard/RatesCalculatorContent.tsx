                ...
                {costsSubTab === "profits" && <TabsContent value="profits">
                    <Tabs value={profitsSubTab} onValueChange={() => {}} className="w-full">
                      ...
                      <TabsContent value="3-star">
                        {profitsSubTab === "3-star" && <div className="glass-card rounded-lg p-8 text-white/80 border-blue-500/20 bg-gradient-to-br from-blue-900/40 to-purple-900/40 backdrop-blur-sm font-normal">
