                    ...
                    <Tabs value={profitsSubTab} onValueChange={() => {}} className="w-full">
                      ...
                      <TabsContent value="3-star">
                        {profitsSubTab === "3-star" && <div className="glass-card rounded-lg p-8 text-white/80 border-blue-500/20 bg-gradient-to-br from-blue-900/40 to-purple-900/40 backdrop-blur-sm font-extrabold">
                            <img alt="3 Star Hotel Profit Model" className="w-full h-auto rounded-lg shadow-lg border border-purple-400/20" src={language === 'es' ? "/lovable-uploads/b64eac94-2ddd-4f00-8657-8f381756e1bb.png" : "/lovable-uploads/6112280a-824f-4699-84f9-1f6bbfdea1ec.png"} />
                          </div>}
                      </TabsContent>
                      ...
                      <TabsContent value="5-star">
                        {profitsSubTab === "5-star" && <div className="glass-card rounded-lg p-8 text-white/80 border-blue-500/20 bg-gradient-to-br from-blue-900/40 to-purple-900/40 backdrop-blur-sm">
                            <img alt="5 Star Hotel Profit Model" className="w-full h-auto rounded-lg shadow-lg border border-purple-400/20" src={language === 'es' ? "/lovable-uploads/a0548794-440c-474f-bf40-47c084049197.png" : "/lovable-uploads/bf5eb578-eabb-4ba4-89aa-0aa672f78584.png"} />
                          </div>}
                      </TabsContent>
                    </Tabs>
                  </TabsContent>}
