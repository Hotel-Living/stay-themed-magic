...
export const PropertyDetailView: React.FC<PropertyDetailViewProps> = ({
  ...
  return <div className="space-y-6 bg-[#5C0869] rounded-2xl p-6 bg-[_#5A0080_]">
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {(hotel.atmosphere || hotel.ideal_guests || hotel.perfect_location) && <Card className="p-6 bg-[#5C0869]">
        ...
        {/* Pricing */}
        {hotel.rates && Object.keys(hotel.rates).length > 0 && <Card className="p-6 bg-[#5C0869]">
