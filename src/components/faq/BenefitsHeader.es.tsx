...
export function BenefitsHeaderES() {
  const isMobile = useIsMobile();

  const benefitsList = [
    "Estadías renovables (Sin contrato, sin depósito)",
    "Sin tareas domésticas (Limpieza, lavandería, platos)",
    "Flujo constante de gente nueva con afinidades compartidas",
    "Elige por afinidades, no por presupuesto",
    "Elimina la soledad y el aislamiento social",
    "Expande tu vida social y red profesional",
    "Servicios diarios (Recepción, seguridad, conserjería)",
    "Paga directamente a hoteles, sin intermediarios"
  ];
