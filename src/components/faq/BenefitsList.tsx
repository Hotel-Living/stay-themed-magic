...
export function BenefitsList({ benefits, className = "" }: BenefitsListProps) {
  ...
  return (
    <div className={`mb-16 ${className}`}>
      ...
      <div className="bg-transparent backdrop-blur-md rounded-xl p-6 border border-fuchsia-800/30 shadow-lg">
        {benefits.map((benefit, index) => (
          <div key={index} className="flex items-start mb-4">
            <span className="inline-block w-4 h-4 rounded-full bg-[#FFF9B0] mr-3 mt-2 flex-shrink-0"></span>
