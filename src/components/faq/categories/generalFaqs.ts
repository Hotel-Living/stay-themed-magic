...
export const generalFaqs: FaqItem[] = [
  ...
  {
    question: "What are renewable stays of 8, 16, 24, or 32 days?",
  ...
  // Question 12 (suitable for families with children) removed as it was question #13 in the overall count
];
