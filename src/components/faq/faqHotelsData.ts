...
export const hotelFaqsByCategory: Record<string, FaqItem[]> = {
  benefits: [
    ...
    {
      question: "How does the Hotels Life model increase my revenue?",
  ...
  programs: [
    ...
    {
      question: "Do I need to dedicate my entire property to the Hotels Life program?",
  ...
  integration: [
    ...
    {
      question: "What kind of support does Hotels Life provide during and after implementation?",
  ...
  revenue: [
    ...
    },
    {
      ...
      answer: "Hotels Life takes a commission of 15-20% on bookings generated through our platform, with the exact percentage depending on exclusivity arrangements and volume commitments. This is comparable to or lower than many OTA commissions, but with the added benefit of longer stays and higher average rates."
    },
    {
      question: "Can we still use other booking channels?",
      answer: "Yes, most partner hotels maintain their existing booking channels alongside our platform. We work with you to develop an inventory allocation strategy that maximizes revenue while ensuring you can meet commitments to both traditional guests and Hotels Life participants."
    },
    {
      question: "How predictable is the revenue from Hotels Life bookings?",
      answer: "Very predictable. Unlike traditional bookings that fluctuate seasonally, our extended-stay and themed programs provide consistent occupancy. Many partners can forecast their Hotels Life revenue months in advance, allowing for better financial planning and resource allocation."
    }
  ],
  guests: [
    {
      question: "What types of guests does Hotels Life attract?",
  ...
  marketing: [
    {
      question: "How does Hotels Life market my property?",
    ...
    {
      question: "Can I use the Hotels Life partnership in my own marketing?",
      answer: "Absolutely! We encourage partners to highlight their Hotels Life affiliation in their own marketing materials. We provide branding assets, content templates, and marketing guidelines to help you leverage the partnership effectively."
    },
    {
      question: "Does Hotels Life help with content creation?",
