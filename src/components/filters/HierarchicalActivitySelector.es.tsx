...
interface HierarchicalActivitySelectorESProps {
...
export const HierarchicalActivitySelectorES: React.FC<HierarchicalActivitySelectorESProps> = ({
  selectedActivities,
  onActivitySelect,
  allowMultiple = true,
  className = "",
  ...
  if (!filteredActivities || filteredActivities.length === 0) {
    return (
      <div className="text-yellow-400 p-4">
        {searchQuery ? "No se encontraron actividades que coincidan con tu búsqueda." : "No hay actividades disponibles"}
      </div>
    );
  }
