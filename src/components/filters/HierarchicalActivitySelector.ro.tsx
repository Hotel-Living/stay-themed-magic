...
interface HierarchicalActivitySelectorROProps {
...
export const HierarchicalActivitySelectorRO: React.FC<HierarchicalActivitySelectorROProps> = ({
  selectedActivities,
  onActivitySelect,
  allowMultiple = true,
  className = "",
  ...
  if (!filteredActivities || filteredActivities.length === 0) {
    return (
      <div className="text-yellow-400 p-4">
        {searchQuery ? "Nu s-au găsit activități care să corespundă căutării tale." : "Nu sunt activități disponibile"}
      </div>
    );
  }
