...
export function FilterSectionWrapper({
  ...
  return <section className="py-0 px-4 mb-16">
      ...
      }} useCollapsibleThemes={true} expandedLayout={true} compactSpacing={true} useBoldLabels={true} usePurpleFilterBackground={true} availableThemes={allPropertyThemes} className="bg-[#860493]" />
        
        <div className="flex justify-center mt-3">
          <Button className="bg-fuchsia-600 hover:bg-fuchsia-700 text-white w-full max-w-6xl flex items-center justify-center" size="lg">
