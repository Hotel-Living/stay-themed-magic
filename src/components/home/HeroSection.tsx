...
export function HeroSection() {
  ...
  return <section className="py-0 px-4 overflow-hidden pt-2 w-full">
      <div className="container relative z-10 max-w-6xl mx-auto text-center">
        ...
        {/* Changed the container background color to #F7E4FC */}
        {/* Doubled the spacing below on mobile (from mb-6 to mb-12) */}
        <div className={`max-w-2xl mx-auto bg-[#F7E4FC] rounded-lg backdrop-blur-sm p-1 ${isMobile ? "mb-12 mt-3 px-0 w-[90%]" : "mb-3 w-[80%]"}`}>
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-0.125 bg-[#f7e4fc]">
