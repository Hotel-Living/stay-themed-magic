      ...
      <div className="container relative z-10 max-w-6xl mx-auto text-center">
        <div className="pt-8 mb-2">
          <h1 className="text-6xl md:text-7xl font-bold mb-2">
            <span className="bg-gradient-to-r from-[#D5A121] to-[#ffff00] bg-clip-text text-transparent animate-text">Live in Hotels</span>
          </h1>
          <h2 className="text-4xl md:text-5xl font-semibold mb-11">
            <span className="bg-gradient-to-r from-[#D5A121] to-[#ffff00] bg-clip-text text-transparent animate-text">Boost your Life</span>
          </h2>
        </div>
