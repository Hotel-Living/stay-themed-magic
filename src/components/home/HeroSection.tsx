        ...
        <div className="pt-6 mb-1">
          ...
          <div className="flex justify-center mb-4">
            <div className="relative w-1/4 mx-auto">
              <div className="rounded-lg px-2 py-1 border-2 border-[#D946EF] bg-black/50 backdrop-blur-sm shadow-[0_0_15px_rgba(217,70,239,0.7)] flex items-center justify-center">
                <p className="text-sm sm:text-base md:text-lg font-bold animate-pulse-glow truncate max-w-full"
                   style={{
                     color: "#fff",
