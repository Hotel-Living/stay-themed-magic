      ...
      <div className="container relative z-10 max-w-6xl mx-auto text-center">
        <div className="pt-6 mb-1">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-1 text-white drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
            <span className="bg-gradient-to-r from-[#996414] via-[#996414] to-[#996414] bg-[length:200%_auto] animate-text-slow bg-clip-text text-transparent">Live in Hotels</span>
          </h1>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 text-white drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
            <span className="bg-gradient-to-r from-[#996414] via-[#996414] to-[#996414] bg-[length:200%_auto] animate-text-slow bg-clip-text text-transparent">Boost your Life!</span>
          </h2>
        </div>
