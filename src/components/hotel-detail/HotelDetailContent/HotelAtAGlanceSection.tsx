  ...
  return (
    <div className="mt-8 p-6 rounded-xl bg-gradient-to-br from-purple-800/30 via-fuchsia-800/20 to-purple-900/30 backdrop-blur-sm border border-white/20 shadow-lg">
      ...
      <div className="space-y-4">
        <div className="p-4 rounded-lg bg-[#791381] backdrop-blur-sm border border-white/20 shadow-[0_0_50px_rgba(121,19,129,0.8),0_0_80px_rgba(121,19,129,0.4)] hover:shadow-[0_0_60px_rgba(121,19,129,1),0_0_100px_rgba(121,19,129,0.6)] transition-all duration-300 transform hover:scale-[1.02]">
