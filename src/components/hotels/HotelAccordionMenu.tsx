      ...
      >
        ...
        >
          <div className="space-y-3 text-left py-6">
            ...
            <p className="text-base font-semibold mt-12">AND MOST OF THEM:</p>
            ...
            <p className="text-base font-semibold mt-12">BECAUSE HUMANITY'S DREAM IS TO LIVE IN A HOTEL</p>
            ...
            <p className="text-base mt-12 font-semibold uppercase">THEY NEED YOUR HOTEL BECAUSE:</p>
            <p className="text-base flex items-start mt-2"><span className="inline-block w-2 h-2 rounded-full bg-fuchsia-400 mr-2 mt-1.5"></span> Because people want to socialize. Make friends</p>
