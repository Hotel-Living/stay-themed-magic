    ...
    <div className="mt-16 text-center">
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-8">
        <div className="glass-card p-6 rounded-xl bg-gradient-to-b from-[#6a0a95] to-[#460F54] transform hover:scale-105 transition-all duration-300 border border-fuchsia-400/30 shadow-lg hover:shadow-[0_0_15px_rgba(217,70,239,0.3)]">
          ...
          <h3 className="text-lg font-semibold mb-3 text-[#f5ecf6]">Ocupación Completa</h3>
          <p className="text-sm text-[#f0e3f2]/90">Mantén tu hotel completamente reservado durante todo el año con nuestra comunidad dedicada de huéspedes de estancias largas.</p>
        </div>
        <div className="glass-card p-6 rounded-xl bg-gradient-to-b from-[#6a0a95] to-[#460F54] transform hover:scale-105 transition-all duration-300 border border-fuchsia-400/30 shadow-lg hover:shadow-[0_0_15px_rgba(217,70,239,0.3)]">
          <div className="w-16 h-16 rounded-full bg-fuchsia-500/20 flex items-center justify-center mx-auto mb-4 border border-fuchsia-400/30">
            <DollarSign className="h-8 w-8 text-fuchsia-300" />
          </div>
          <h3 className="text-lg font-semibold mb-3 text-[#f5ecf6]">Mayor Ingresos</h3>
        ...
        <div className="glass-card p-6 rounded-xl bg-gradient-to-b from-[#6a0a95] to-[#460F54] transform hover:scale-105 transition-all duration-300 border border-fuchsia-400/30 shadow-lg hover:shadow-[0_0_15px_rgba(217,70,239,0.3)]">
          ...
          <p className="text-sm text-[#f0e3f2]/90">Únete a una red mundial de hoteles que atienden a viajeros de afinidad y nómadas digitales.</p>
        </div>
      </div>
    </div>
  );
