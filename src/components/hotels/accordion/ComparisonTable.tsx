...
import { getComparisonItemKeys } from './comparisonData';
...
export function ComparisonTable({ items }: ComparisonTableProps) {
  ...
  // Get comparison items from translation system
  const comparisonItems = t('hotels.accordion.comparison.items', { returnObjects: true }) as ComparisonItem[];
  const itemKeys = getComparisonItemKeys();
