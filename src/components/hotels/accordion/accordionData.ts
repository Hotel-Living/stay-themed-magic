...
export const hotelAccordionMenuItems: MenuItemContent[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "For years, apartment rentals have taken our guests,",
      "Our bookings. Our profits.",
      "They've filled their spaces by emptying our rooms.",
      "",
      "But we provide jobs. We pay taxes. We build community.",
      "",
      "An outdated business model",
      "kept us from reacting.",
      "",
      "But we've lost more than enough.",
      "",
      "Hotel-Living activates our unmatched advantage:",
      "Our nearly 100%-profit 40%",
      "vacant rooms — once we pass break-even.",
      "",
      "Let's beat rental apartments at their own game:",
      "Longer stays. Smarter pricing. Plus...",
      "Safety. Service. Warmth. Quality.",
      "No isolation. Just atmosphere. Convenience.",
      "",
      "Everything they lack — while we leave rooms empty.",
      "1.6 billion vacant room-nights",
      "every year. Generating losses.",
      "",
  ...
  },
  {
    ...
    content: [
      ...
      "Stronger loyalty. Deeper commitment",
      "Fewer headaches. Happier employees"
    ]
  },
  {
    id: "boost-atmosphere",
    ...
    content: [
      ...
      "No more lifeless halls",
      "Guests connect. Energy flows",
      "Atmosphere attracts. Staff thrives",
      "An active community creates authentic vibes"
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "They want you to take care of their household chores",
      "They urgently need your empty rooms and services",
      "Just help them: give them both"
    ]
  },
  {
