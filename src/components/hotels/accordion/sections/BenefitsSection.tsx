...
export function BenefitsSection() {
  return (
    <div className="space-y-0 pl-4 border-l-2 border-fuchsia-400/30">
      ...
      <CollapsibleMenuItem title="1.1 100% occupancy year-round" className="mb-1" titleClassName="text-sm">
      ...
      <CollapsibleMenuItem title="1.2 Higher average daily rate (ADR)" className="mb-1" titleClassName="text-sm">
        <div className="space-y-4 text-left py-4">
      ...
      <CollapsibleMenuItem title="1.3 Lower operational costs" className="mb-1" titleClassName="text-sm">
        <div className="space-y-4 text-left py-4">
      ...
      <CollapsibleMenuItem title="1.4 Greater staff stability" className="mb-1" titleClassName="text-sm">
        <div className="space-y-4 text-left py-4">
      ...
      <CollapsibleMenuItem title="1.5 Added revenue from themed activities" className="mb-1" titleClassName="text-sm">
        <div className="space-y-4 text-left py-4">
