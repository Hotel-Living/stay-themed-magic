...
export function ProfitSection() {
  return (
    <div className="space-y-0 pl-4 border-l-2 border-fuchsia-400/30">
      {/* Western hotels */}
      <CollapsibleMenuItem title="4.1 Western hotels. How much profit are we missing every year?" className="mb-1" titleClassName="text-sm">
      ...
      {/* Your hotel profit */}
      <CollapsibleMenuItem title="4.2 And how much profit is your hotel missing every year?" className="mb-1" titleClassName="text-sm">
        <div className="space-y-4 text-left py-4">
          ...
          <p className="text-base flex items-center"><span className="inline-block w-2 h-2 rounded-full bg-fuchsia-400 mr-2"></span> A 200-room resort closing from October to May not only misses $1 million in profit yearly, but also racks up $420,000 in losses</p>
          <p className="text-base flex items-center"><span className="inline-block w-2 h-2 rounded-full bg-fuchsia-400 mr-2"></span> And a 500-room resort? Over $3 million in lost profit every year. And the losses? Let's not even look…</p>
        </div>
      </CollapsibleMenuItem>
      
      {/* Missing potential */}
      <CollapsibleMenuItem title="4.3 Yes. The vast majority of hotels are missing their true profit potential" className="mb-1" titleClassName="text-sm">
        <div className="space-y-4 text-left py-4">
          ...
          <p className="text-base flex items-center"><span className="inline-block w-2 h-2 rounded-full bg-fuchsia-400 mr-2"></span> It doesn't matter if we're 5 stars or 3: we're all missing the point and a lot of money</p>
