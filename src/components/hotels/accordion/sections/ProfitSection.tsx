...
export function ProfitSection() {
  return (
    <div className="space-y-0 pl-4 border-l-2 border-fuchsia-400/30">
      {/* Western hotels */}
      <CollapsibleMenuItem title="4.1 Western hotels. How much profit are we missing every year?" className="mb-4">
        <div className="space-y-2 text-left">
          ...
          <p className="text-base">- That means we reach break-even,</p>
          <p className="text-base ml-4">pay our costs, and make some earnings</p>
          <p className="text-base">- But we don't capture the real profit:</p>
          <p className="text-base ml-4">the remaining 40% of vacant rooms. Our pure profit</p>
        </div>
      </CollapsibleMenuItem>
      
      {/* Your hotel profit */}
      <CollapsibleMenuItem title="4.2 And how much profit is your hotel missing every year?" className="mb-4">
        <div className="space-y-2 text-left">
          ...
          <p className="text-base">- A 500-room resort?</p>
      ...
      {/* Missing potential */}
      <CollapsibleMenuItem title="4.3 Yes. The vast majority of hotels are missing their true profit potential" className="mb-4">
        <div className="space-y-2 text-left">
