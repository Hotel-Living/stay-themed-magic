...
export function ProfitSection() {
  return (
    <div className="space-y-0 pl-4 border-l-2 border-fuchsia-400/30">
      {/* Western hotels - Added dash and extra spaces after number */}
      <CollapsibleMenuItem title="4.1-   Western hotels. How much profit are we missing every year?" className="mb-1" titleClassName="text-[1.05rem]"> {/* Reduced from 1.17rem to 1.05rem (10% smaller) */}
      ...
      {/* Your hotel profit - Added dash and extra spaces after number */}
      <CollapsibleMenuItem title="4.2-   And how much profit is your hotel missing every year?" className="mb-1" titleClassName="text-[1.05rem]"> {/* Reduced from 1.17rem to 1.05rem (10% smaller) */}
        <div className="space-y-4 text-left py-4">
      ...
      {/* Missing potential - Added dash and extra spaces after number */}
      <CollapsibleMenuItem title="4.3-   Yes. The vast majority of hotels are missing their true profit potential" className="mb-1" titleClassName="text-[1.05rem]"> {/* Reduced from 1.17rem to 1.05rem (10% smaller) */}
        <div className="space-y-4 text-left py-4">
