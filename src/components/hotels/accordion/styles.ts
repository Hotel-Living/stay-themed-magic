...
export const accordionMenuItemStyles = () => ({
  ...
  content: "text-white space-y-4 pt-4 overflow-visible" // Added overflow-visible to prevent scrolling
});
...
export const collapsibleMenuItemStyles = () => ({
  ...
  content: "mt-6 mb-6 overflow-visible" // Made content overflow visible
});
