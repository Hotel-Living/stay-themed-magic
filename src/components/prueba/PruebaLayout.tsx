...
const pruebaTabs = [
  ...
  },
  {
    ...
    path: "/prueba/bookings"
  },
  {
    id: "payments",
    label: "Payments", 
    icon: <CreditCard className="w-5 h-5" />,
    path: "/prueba/payments"
  },
  {
    id: "affinities",
    label: "Affinities",
    icon: <Calendar className="w-5 h-5" />,
    path: "/prueba/affinities"
  },
  {
    id: "filters",
    label: "Filters",
  ...
  },
  {
    ...
    path: "/prueba/translations"
  },
  {
    id: "communications",
    label: "Communications",
    icon: <MessageCircle className="w-5 h-5" />,
    path: "/prueba/communications"
  },
  {
    id: "advertising",
    label: "Advertising",
    icon: <Megaphone className="w-5 h-5" />,
    path: "/prueba/advertising"
  },
  {
    id: "statistics",
    label: "Statistics",
    icon: <BarChart3 className="w-5 h-5" />,
    path: "/prueba/statistics"
  },
  {
    id: "roles",
    label: "Roles",
