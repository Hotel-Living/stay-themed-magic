...
import { mockActivities } from "@/components/simulation/MockFilterData";

interface ActivityFilterSimulationProps {
  activeActivities: string[];
  onChange: (value: string, isChecked: boolean) => void;
}

export function ActivityFilterSimulation({ activeActivities, onChange }: ActivityFilterSimulationProps) {
