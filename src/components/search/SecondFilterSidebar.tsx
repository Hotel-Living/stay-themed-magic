...
export function SecondFilterSidebar({
  ...
  return <div className="flex flex-col h-full w-fit max-w-full bg-gradient-to-b from-[#460F54] to-[#300A38]">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {/* THEME/AFFINITY */}
        <ThemeFilter activeTheme={activeFilters.theme} onChange={handleThemeChange} />
        ...
        {/* CATEGORY */}
        <CategoryFilter activeCategory={activeFilters.atmosphere} onChange={value => handleFilterChange('atmosphere', value)} />
      ...
      {isReady && <div className="p-4 border-t border-white/10">
          <button onClick={onResetAllFilters} className="w-full bg-[#1E5C3D] hover:bg-[#2A6B4A] text-white px-4 py-2 rounded-lg font-medium transition-colors">
