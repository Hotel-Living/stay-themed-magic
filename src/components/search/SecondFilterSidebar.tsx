...
export function SecondFilterSidebar({
  ...
  return <div className="bg-gradient-to-br from-purple-950/90 to-purple-900/70 backdrop-blur-md border border-purple-600/30 p-4 shadow-2xl w-full max-w-xs px-0 py-0 rounded-lg">
      ...
      <div className="mb-4">
        <LengthOfStayFilter activeLength={activeFilters.stayLengths?.[0]?.toString() || null} onChange={value => handleArrayFilterChange('stayLengths', value, true)} />
      </div>
      ...
      {/* Meal Plans Filter */}
      <div className="mb-4">
        <CheckboxFilter title="MEAL PLAN" options={['Breakfast', 'Half Board', 'Full Board', 'All Inclusive']} selectedOptions={activeFilters.mealPlans} onChange={(value, isChecked) => handleArrayFilterChange('mealPlans', value, isChecked)} />
      </div>
