...
>(({ className, children, titleClassName, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    ...
    >
      ...
      <ChevronDown className="h-4 w-4 shrink-0 transition-transform duration-300 text-fuchsia-400 group-hover:text-[#FEF7CD]" />
    </AccordionPrimitive.Trigger>
