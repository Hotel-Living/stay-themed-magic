  ...
  return <div className="min-h-screen flex flex-col faq-page">
      ...
      <main className="flex-1 pt-16">
        <div className="container max-w-4xl mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-2 text-center text-gradient">Hotel Partner FAQ</h1>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="w-full flex justify-start overflow-x-auto py-2 px-1 bg-muted/20 rounded-xl mb-6 gap-1">
              {hotelFaqCategories.map(category => <TabsTrigger key={category.id} value={category.id} className="px-4 py-1.5 rounded-lg text-sm capitalize whitespace-nowrap">
                  {category.name}
                </TabsTrigger>)}
            </TabsList>
