...
const marketCreationData = {
  paragraphs: [
    "🚀 We haven't just created a business — we've created an entirely new global market",
    "• 🌍 A completely new business model, legally registered and protected",
    "• 💰 With $12 billion in estimated annual profits",
    "• 🌐 And access to a brand-new $131 billion global market",
    "• ✅ A market that belongs entirely to us"
  ]
};
...
const saasApplicationData = {
  paragraphs: [
    ...
    "🚦Our revolution is fully legal",
    "• We are not Uber.",
    "• We don't break the system — we empower it with smart, lawful innovation.",
    "________________________________________",
    "🤝 What do we do?",
    "We connect two worlds in urgent need of each other:",
    "1. 🏨 Hospitality businesses losing millions to underused resources",
    "2. 👥 People looking to radically improve their lives through meaningful, long-term stays",
    "________________________________________",
    "💡 A simple, legal, game-changing solution.",
    "And it's ready to reshape the future of lodging"
  ]
};
...
const problemsWeSolveData = {
  paragraphs: [
    ...
    "• Over 4 million rooms remain completely empty for months on end.",
    "________________________________________",
    ...
    "________________________________________",
    "These are 270 million individuals with stable income and freedom of movement.",
    "• Their \"impossible dream\"?",
    "To live as if on permanent vacation — with everything taken care of, full of services, attention, vibrant social interaction, and constant activities.",
    "• And if they're going to dream...",
    "They'd dream of being surrounded by people who share their values, interests, and lifestyle.",
    "Because the ultimate life?",
    "Is to live among people who truly match who you are."
  ]
};
...
const hotelLivingSolutionData = {
  paragraphs: [
    "💡 At Hotel-Living, we've solved both sides of the equation.",
    "While the hotel industry bleeds from underused capacity,",
    "millions of people dream of living better lives.",
    "We didn't just patch the problem —",
    "we built a new system. A powerful, elegant, and absolutely unprecedented model, designed to revolutionize the way we live, travel, and connect.",
    "________________________________________",
    "🧠 HOTEL-LIVING IS A RADICAL SHIFT",
    "✅ We turn empty rooms into full lives.",
    "• We help hotels monetize what's losing them money:",
    "their unused rooms, closed wings, and off-season operations.",
    "• And we give individuals — retirees, remote workers, couples, solo livers —",
    "a new way to live:",
    "in comfort, community, and complete freedom from domestic routines.",
    "________________________________________",
    "🧩 A SYSTEM OF INTELLIGENT MODULES",
    "Hotel-Living is not just a booking platform.",
    "It's a fully integrated, smart-living ecosystem made of powerful modules:",
    ...
    "• 🏷️ Marketing modules: built-in tools for hotels to attract the right guest, every time",
    "________________________________________",
    "🌍 GLOBAL, LEGAL, READY",
    "• ✅ Fully legal — no conflicts like Uber",
    "• 🛠️ Fully scalable — we're a SaaS product",
    "• 🌎 Ready for instant rollout in any country",
    "• 🧾 Business model fully registered and protected"
  ]
};
...
const impactData = {
  paragraphs: [
    "________________________________________",
    "• 💰 $12B in projected annual net profits",
    "• 🌐 A $131B market — created from scratch",
    "• 🔐 And yes, it's 100% ours"
  ]
};
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <TextSection 
              ...
              paragraphs={marketCreationData.paragraphs} 
            />
            
            {/* New section - We are a SaaS application */}
            <TextSection 
              icon={Wrench} 
              title="🛠️ We are a SaaS application" 
              paragraphs={saasApplicationData.paragraphs} 
            />
            ...
            <TextSection 
              ...
              paragraphs={problemsWeSolveData.paragraphs} 
            />
            
            {/* New section - The Hotel-Living Solution */}
            <TextSection 
              icon={Star} 
              title="The Hotel-Living Solution" 
              paragraphs={hotelLivingSolutionData.paragraphs} 
            />
            ...
            <TextSection 
              icon={BarChart3} 
              title="THE IMPACT" 
              paragraphs={impactData.paragraphs} 
            />
